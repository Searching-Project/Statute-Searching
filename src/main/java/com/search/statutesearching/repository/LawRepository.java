...
public interface LawRepository extends JpaRepository<Law,String> {
    ...
    @Query(value = "(" +
            ...
            "JOIN (SELECT a2.lawsn, a2.content, a2.title, a2.article_id FROM article AS a2 where MATCH(a2.content) AGAINST(:keyword IN NATURAL LANGUAGE MODE )) AS a using(lawsn)) AS aa " +
